...
class DottedTool: UIBezierPath, SketchTool {
    ...
    func draw() {
        ...
        let dashStroke: CGFloat = CGFloat(lineWidth / 5)
        let dashSkip: CGFloat = CGFloat(lineWidth * 10)
        let dashes: [CGFloat] = [dashStroke, dashSkip, dashStroke, dashSkip]
